...
class BasePage:
    ...
    def _go_backoffice_page(self):
        self.logger.info('Go to backoffice page')
        backoffice_url = "/admin123"
        self.browser.get(self.browser.url + backoffice_url)

    def _go_to_main_page(self):
        self.logger.info('Go to main URL')
